...
const MENU_ITEMS: ProfileMenuItem[] = [
  { id: "earnings", icon: "calendar", label: "My Earnings" },
    ...
    <SafeAreaView style={s.safe} edges={["top"]}>
      ...
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.profileCard}>
          ...
          <Text style={s.profilePhone}>Provider Account</Text>
          <Pressable 
            style={s.editBtn} 
            ...
            return (
              ...
              >
                <View style={s.menuLeft}>
                  <Icon size={24} color={isDestructive ? Colors.error : Colors.secondary} />
                  <Text style={[s.menuLabel, isDestructive && { color: Colors.error }]}>
                    {item.label}
                  </Text>
                </View>
...
const s = StyleSheet.create({
  ...
  profileCard: {
    ...
    borderColor: Colors.outline + "26", borderRadius: 12,
    padding: 32, alignItems: "center", gap: 8,
  },
  avatarLg: {
    width: 96, height: 96, borderRadius: 48,
    backgroundColor: Colors.surfaceVariant, borderWidth: 1,
    borderColor: Colors.outline + "1A", alignItems: "center",
  ...
  editBtn: {
    ...
    borderWidth: 1, borderColor: Colors.outline, borderRadius: 4,
  },
